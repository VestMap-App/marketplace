...
| Growth panel | Expansion CAGR at the five scales as bars (block bar green, others sage; widths ∝ value/max, min 2.5%); note: "Growth tightens as the geography shrinks: the block runs **{block/national}×** the national rate and **{block/county}×** {County Name}." (ratios 1dp, drop a ratio if its denominator ≤ 0) |
